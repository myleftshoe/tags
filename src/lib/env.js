...
export const USERNAME = isProd ? process.env.USERNAME : import.meta.env.VITE_USERNAME
export const PASSWORD = isProd ? process.env.PASSWORD : import.meta.env.VITE_PASSWORD
